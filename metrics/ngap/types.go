...
const (
	...
	AMF_TIME_REINIT_ERR                            = "Please Wait at least for the indicated time before reinitiating toward same AMF"
	AMF_UE_NIL_ERR                                 = "AmfUe is nil"
	AOI_LIST_OOR_ERR                               = "AOI List out of range"
	CAUSE_NIL_ERR                                  = "Cause present is nil"
	ERROR_INDICATION_CAUSE_AND_CRITICALITY_NIL_ERR = "Both cause and criticality are nil, one of them should be set in the message"
